...
export function Phantom3DPage() {
  return (
    <>
      <header className="detailHero">
        <nav className="nav" aria-label="phantom3D 상세 페이지 탐색">
        ...
        <section className="detailHeroInner">
          <p className="eyebrow">phantom3D Detail</p>
          <h1>{portfolio.phantom3DProject.title}</h1>
          <p className="heroLead">{portfolio.phantom3DProject.subtitle}</p>
        </section>
      </header>
      <main>
        <MainProject project={portfolio.phantom3DProject} />
        <ProjectDetail project={portfolio.phantom3DProject} />
